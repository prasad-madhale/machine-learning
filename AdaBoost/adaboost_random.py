...
class AdaBoost:
    ...
    def plot_round_error(round_errors):
        ...
        plt.savefig('./plots/random_round_error.png')
        plt.close()
    ...
    def plot_train_test_error(train_error, test_error):
        ...
        plt.savefig('./plots/random_train_test_error.png')
        plt.close()
    ...
    def plot_auc(aucs):
        ...
        plt.title('AUC')
        plt.plot(aucs)
        plt.savefig('./plots/random_auc.png')
        plt.close()
    ...
    def plot_roc(truth, preds):
        ...
        plt.savefig('./plots/random_roc.png')
        plt.close()
...
ada_boost.fit(num_weak_learners=2000)
