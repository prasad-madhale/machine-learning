...
def preprocess(train_data, train_label, test_data, test_label):

    # combine test and train as we are going to use k-folds
...
with open('./logs/out.txt', 'w') as f:
    ...
    data = preprocess(train_data, train_label, test_data, test_label)
